...
public enum Options {
    ...
    OPTION_HISTOGRAM(0x05),    /* 0 = only one,
                                  1 = continue mode */
    OPTION_BITDEPTH(0x06),    /* 0 = 8bits mode,
                                 1 = 16bits mode */
    OPTION_FAN(0x07),    /* 0 = turn off the cooling fan,
                            1 = turn on the cooling fan */
    OPTION_COOLER(0x08),     /* 0 = turn off cooler,
                                1 = turn on cooler */
    OPTION_LINEAR(0x09),      /*0 = turn off tone linear,
                                1 = turn on tone linear */
    OPTION_CURVE(0x0a),    /* 0 = turn off tone curve,
                              1 = turn on tone curve */
    OPTION_TRIGGER(0x0b),    /* 0 = video mode,
